...
if (isset($_POST['submit'])) { // to check wheather form submit or not
	if (isset($_POST['email']) && $_POST['email'] == $email && $_POST['password'] == $pass) {
		$email = $_SESSION['myEmail'];
		$pass = $_SESSION['mypass'];
		$fname = $_POST['fname'];
		$lname = $_POST['lname'];
		$read = "SELECT * FROM `userdata` WHERE `email`= '$email' && `password`='$pass'";
		// Execute Query to insert data in table
		$executeReadQuery = mysqli_query($connect, $read);
		//  update update update 
		$updateQuery = "UPDATE `userdata` SET `firstname`='$fname', `lastname`='$lname',`email`='$email' WHERE `email` = '$email'";
		// Execute Query to insert data in table
		...
		if ($executeUpdateQuery) {
			...
			header('location: http://localhost/demo2/dist/account/overview.php');
		}
	} else {
		// echo 'wrong email'
		...
		<strong>Holy guacamole!</strong> You should check your email or password.
	  ...
	  </div>'; //email validation form update form
	}
}
?>
<!DOCTYPE html>
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
															...
															<div class="menu-item">
																<a class="menu-link active py-3" href="../../demo2/dist/account/settings.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Settings</span>
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
												...
												<div class="menu-item px-3">
													<div class="menu-content d-flex align-items-center px-3">
														...
														<!--begin::Username-->
														<div class="d-flex flex-column">
															<div class="fw-bolder d-flex align-items-center fs-5"><?php echo $firstname . ' ' . $lastname; ?>
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							...
							<div class="d-flex align-items-center py-3 py-md-1">
								...
								<div class="me-4">
									...
									<!--begin::Menu 1-->
									<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61485009dc541">
										<!--begin::Header-->
										<div class="px-7 py-5">
										...
										<div class="px-7 py-5">
											...
											<div class="mb-10">
												...
												<!--begin::Input-->
												<div>
													<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61485009dc541" data-allow-clear="true">
														<option></option>
						...
						<div class="content flex-row-fluid" id="kt_content">
								...
								<div class="card-body pt-9 pb-0">
											...
											<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
												...
												<div class="d-flex flex-column">
													...
													<div class="d-flex align-items-center mb-2">
														<a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1"><?php echo $firstname . ' ' . $lastname; ?></a>
														<a href="#">
									...
									<div class="d-flex overflow-auto h-55px">
										<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
											<!--begin::Nav item-->
											<li class="nav-item">
												<a class="nav-link text-active-primary me-6" href="../../demo2/dist/account/overview.html">Overview</a>
											</li>
											<!--end::Nav item-->
											<!--begin::Nav item-->
											<li class="nav-item">
							...
							<div class="card mb-5 mb-xl-10">
								...
								<div id="kt_account_profile_details" class="collapse show">
									<!--begin::Form-->
									<form id="myform" class="form" method="post" action="">
										<!--begin::Card body-->
										<div class="card-body border-top p-9">
											...
											<div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
													<input type="text" name="password" class="form-control form-control-lg form-control-solid" placeholder="Enter password"/>
												</div>
												<!--end::Col-->
											</div>		
											<!--end::Input group-->
							...
							<div class="mh-300px scroll-y me-n7 pe-7">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<!--begin::Details-->
										<div class="ms-5">
											<a href="#" class="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2"><?php echo $firstname . ' ' . $lastname; ?></a>
											<div class="fw-bold text-muted"><?php echo $email; ?></div>
										</div>
										<!--end::Details-->
									</div>
									<!--end::Details-->
