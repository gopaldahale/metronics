...
$executeFetch = mysqli_query($connect, $fetch);
$row = mysqli_fetch_assoc($executeFetch);
...
if (isset($_POST['edit-submit'])) {
	...
	if (!empty($firstname) && !empty($lastname) && !empty($email)) {   
		$fetch1 = "SELECT * FROM `userdata` WHERE `srno`= '$srno'";
		// Execute Query to insert data in table
		$executeFetchQuery1 = mysqli_query($connect, $fetch1);
		$row1 = mysqli_fetch_assoc($executeFetchQuery1);
		//  update update update 
		$updateQuery = "UPDATE `userdata` SET `firstname`='$firstname', `lastname`='$lastname',`email`='$email' 
										  WHERE `srno` = '$srno'";
		// Execute Query to insert data in table
		$executeUpdateQuery = mysqli_query($connect, $updateQuery);
		if ($executeUpdateQuery) {
			header("location: http://localhost/demo2/dist/apps/user-management/users/list.php");
		}
	} else {
		// echo 'error';
		$emptyFieldErr = true;
...
if (isset($emptyFieldErr) && $emptyFieldErr == true) {
	echo '<div class="alert alert-warning alert-dismissible fade show" role="alert" style="position:absolute;top:5%;left:50%;transform: translate(-50%, -50%);padding-left:50px;z-index:99;width:40%;">
	<span style="text-align:justify;"><strong>Holy guacamoly !</strong> you are submitting some fields !
...
if (isset($_POST['delete-submit'])) {
	if (isset($_POST['deleteData'])) {
		$srrno = $_POST['deleteData'];
		//  delete query 
		$deleteQuery = "DELETE FROM `userdata` WHERE `srno` = $srrno";
		$executeDelete = mysqli_query($connect, $deleteQuery);
		if ($executeDelete) {
			header("location: http://localhost/demo2/dist/apps/user-management/users/list.php");
		}
	} else {
...
<html lang="en">
	...
	<body id="kt_body" style="background-image: url(assets/media/patterns/header-bg.jpg)" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
									...
									<div class="topbar d-flex align-items-stretch flex-shrink-0">
										...
										<div class="d-flex align-items-center me-n3 ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
												...
												<!--begin::Menu item-->
												<div class="menu-item px-5">
													<a href="account/logout.php" class="menu-link px-5">Sign Out</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu separator-->
												<div class="separator my-2"></div>
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							...
							<div class="d-flex align-items-center py-3 py-md-1">
								...
								<div class="me-4">
									...
									<!--begin::Menu 1-->
									<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6148503a46103">
										<!--begin::Header-->
										<div class="px-7 py-5">
										...
										<div class="px-7 py-5">
											...
											<div class="mb-10">
												...
												<!--begin::Input-->
												<div>
													<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6148503a46103" data-allow-clear="true">
														<option></option>
										...
										<div class="modal fade" id="kt_modal_add_user" tabindex="-1" aria-hidden="true">
											...
											<div class="modal-dialog modal-dialog-centered mw-650px">
												...
												<div class="modal-content">
													...
													<!--end::Modal header-->
													<!--begin::Modal add user body-->
													<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
														<!--begin::Form-->
														<form id="kt_modal_add_user_form" class="form" method="post" action="authentication/flows/basic/sign-up.php">
															<!--begin::Scroll-->
															<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																...
																<div class="fv-row mb-7">
																	<!--begin::Label-->
																	<label class="required fw-bold fs-6 mb-2">Firstname</label>
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="first-name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="firstname" value="" />
																	<!--end::Input-->
																</div>
																<div class="fv-row mb-7">
																	<!--begin::Label-->
																	<label class="required fw-bold fs-6 mb-2">Lastname</label>
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="last-name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="lastname" value="" />
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
																<!--begin::Input group-->
																...
																<div class="mb-7">
																	...
																	<div class="d-flex fv-row">
																		...
																		<div class="form-check form-check-custom form-check-solid">
																			<!--begin::Input-->
																			<input class="form-check-input me-3" name="admin-submit" type="radio" value="0" id="kt_modal_update_role_option_0" />
																			<!--end::Input-->
																			<!--begin::Label-->
															...
															<div class="text-center pt-15">
																<button type="reset" class="btn btn-light me-3" data-kt-users-modal-action="cancel">Discard</button>
																<button data-kt-users-modal-action="submit" hidden>
																	<span class="indicator-progress">Please wait...
																	<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
																</button>
										...
										<div class="modal fade" id="kt_modal_edit_user" tabindex="-1" aria-hidden="true">
											...
											<div class="modal-dialog modal-dialog-centered mw-650px">
												...
												<div class="modal-content">
													...
													<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
														<!--begin::Form-->
														<form id="kt_modal_add_edit_user_form" class="form" method="post" action="">
															<!--begin::Scroll-->
															<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																<!--begin::Input group-->
																<div class="fv-row mb-7">
																...
																<div class="fv-row mb-7">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input id="editfirstnameid" type="text" name="edit-first-name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="firstname" value="" />
																	<!--end::Input-->
																</div>
																<div class="fv-row mb-7">
																	<!--begin::Label-->
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input id="editlastnameid" type="text" name="edit-last-name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="lastname" value="" />
																	<!--end::Input-->
																</div>
																<!--end::Input group-->
																<!--begin::Input group-->
																<div class="fv-row mb-7">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input id="editemailid" type="email" name="edit-email" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="example@domain.com" value="" />
																	<!--end::Input-->
																</div>
																<input id="editsrnoid" type="hidden" name="snoEdit">
																<!--end::Input group-->
															</div>
															<!--end::Scroll-->
															<!--begin::Actions-->
															<div class="text-center pt-15">
																<button type="reset" class="btn btn-light me-3" data-kt-users-modal-action="cancel">Discard</button>
																<button name="edit-submit" type="submit" class="btn btn-primary">
																	<span class="indicator-label">Submit</span>
																	<span class="indicator-progress">Please wait...
																	<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
																</button>
								...
								<div class="card-body pt-0">
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
										...
										<tbody class="text-gray-600 fw-bold">
											...
											// $executeFetch = mysqli_query($connect, $fetch);
											// $row = mysqli_fetch_assoc($executeFetch);
											while ($row = mysqli_fetch_assoc($executeFetch)) {
												echo '<tr>
												<!--begin::Checkbox-->
												<td>
												...
												<td class="d-flex align-items-center">
													...
													<div class="d-flex flex-column">
														<!-- <h6 class="text-gray-800 text-hover-primary mb-1">' /*. $row['firstname'] . ' ' . $row['lastname'] */. '</h6> -->
														 <a href="" class="text-gray-800 text-hover-primary mb-1 d-flex" style="column-gap:5px;"> <h6 class="text-gray-800 text-hover-primary mb-1" >' . $row['firstname'] . '</h6><h6 class="text-gray-800 text-hover-primary mb-1" > ' . $row['lastname'] . '</h6></a> 
												...
												<td class="text-end">
													...
													<div style="row-gap: 5px;" class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
														
														<div class="menu-item px-3" >
															<button  id="' . $row['srno'] . '" class="edit menu-link px-3 justify-content-center w-100" style="border:none;" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_user">Edit</button>
														</div>
														
														<div class="menu-item px-3">
															<button  id="' . $row['srno'] . '" class="delete px-3 justify-content-center w-100" data-bs-toggle="modal" data-bs-target="#deleteModal">Delete</button>
														</div>
		...
		<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-modal="true">
	  ...
	  <div class="modal-content">
		...
		<form action="" method="post" class="m-2">
		  <div class="modal-body">
			<input type="hidden" name="deleteData" id="snoDelete">
			<p>Are you sure to delete your data?</p>
			<div class="modal-footer">
			  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
			  <button name="delete-submit" type="submit" class="btn btn-danger">Delete</button>
			</div>
		  </div>
		</form>
		...
		<script>
			...
			Array.from(edits).forEach((element) => {
				element.addEventListener("click", (e) => {
					...
					// Get the values from the row's table cells (td)
					firstname = tr.querySelector('td:nth-child(2) h6').textContent;
					lastname = tr.querySelector('td:nth-child(2) h6:nth-child(2)').textContent;
					email = tr.querySelector('td:nth-child(2) span').textContent;

					// Now you can use the 'username' and 'email' variables as needed
					console.log('Username:'+ firstname + lastname);
					console.log('Email:'+ email);

					editfirstnameid.value = firstname;
					editlastnameid.value = lastname;
					editemailid.value = email;
					editsrnoid.value = e.target.id;
			...
			deletes = document.getElementsByClassName('delete');
				Array.from(deletes).forEach((elment) => {
				elment.addEventListener("click", (d) => {
